...
| **Normalize** | Convert raw fields into ISC types and fields | When data is “present” but wrong format or wrong value |
| **Persist** | Create, update, disable, or delete stored objects | When records exist but don’t update correctly |
...
| **Recompute** | Recalculate access model (roles, access profiles, policies) | When roles or access don’t match identity reality |
